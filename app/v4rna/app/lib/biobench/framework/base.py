...
class Response( object ):
    ...
    def __init__( self ):
        ...
        self.headers [ "Access-Control-Allow-Headers" ] = "Content-Type, X-Requested-With, X-Requested-By"
...
def safe_dict(d):
    """Recursively clone dict with UTF-8 dictionary keys""" 
