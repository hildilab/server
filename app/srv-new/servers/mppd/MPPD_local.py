...
def page_url( page ):
    return url_for( 'pages', page=page )#URL_DIR + url_for( 'pages', page=page )

def static_url( filename ):
    return url_for( 'basic_staticx', filename=filename )#URL_DIR + url_for( 'staticx', filename=filename )
...
#
def mppd_static_url( filename ):
    return url_for( 'mppd_staticx', filename=filename )#URL_DIR + url_for( 'staticx', filename=filename )

def mppd_img_url( filename ):
    return mppd_static_url( "img/" + filename )
