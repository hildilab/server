		...
		<ol>
			...
			<li>
				<div class="reference" id="1">
					<span class="title">A fragement based method for modeling of protein segments into cry-EM density maps.</span>
					<span class="authors">Ismer, J. et al.</span>
					<span class="magazine">BMC Bioinformatics</span>
					<span class="year">(2017)</span>
					<span class="issue">18(1):475</span>
				</div>
			</li>
			<li>
			...
			<li>
				<div class="reference" id="9">
					<span class="title">Loopholes and missing links in protein modeling.</span>
					<span class="authors">Rossi, K.A. et al.</span>
					<span class="magazine">Protein Sci.</span>
					<span class="year">(2007)</span>
					<span class="issue">16, 1999&#151;2012</span>
				</div>
			</li>
        ...
        <h2>Further reading</h2>
			<li>
				<div class="reference" id="11">
					...
					<span class="issue">78, 1431&#151;40</span>
				</div>
			</li>
			<li>
