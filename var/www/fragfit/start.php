	...
	?>	
		...
		<div id="content" class="content">
			...
			<div class="middleblock">
			   ...
			   of missing segments such as loops or hige regions into cryo-Electron Microscopy (cryo-EM) density maps  <a target="_self" href="references.php">[1]</a>.
			   ...
			   entries (Nov 2017) extracted from structural coordinates deposited in the PDB <a target="_self" href="references.php">[2]</a>.
			   A fast hierarchical search algorithm (FragSearch <a target="_self" href="references.php">[3]</a>) selects up to 100 suitable
			   ...
			   positive predictions, the provided map is preprocessed.
				...
				<h3>Visualization</h3>
				   Integration of the NGL viewer <a target="_self" href="references.php">[4]</a>, a molecular viewer based on WebGL,
			   ...
			   By inspection of the best 5 fitted fragments, prediction quality is enhanced <a target="_self" href="references.php">[1]</a>.
