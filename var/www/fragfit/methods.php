...
<body>
   <div id="container">
	...
	of fragments sum up to over 1.000 million (Nov 2017). The number of available fragments
	...
	transmembrane proteins in the PDB rose from 805 to >2.298 (Nov 2017). The number of loops in the database
	increased from 180.000 to >390.000 (Nov 2017). This database is also included in the default.
...
Finally the found fitting fragments are re-scored according to their cross-correlation to this preprocessed cryo-EM map.</p>
	...
	For the calculation of the membrane planes we employ the web-service TMDET.
	 As result of the calculation TMDET <a target="_self" href="references.php">[5]</a> provides a list of residues that tangent the membrane.
