<?php /* Smarty version 2.6.20, created on 2018-05-02 07:55:04
         compiled from methods_learning.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ref', 'methods_learning.tpl', 9, false),)), $this); ?>
...
<div class="contentblock">
  ...
  <div class="textblock">
    <p>
      ...
      were first selected and analyzed as described in [<?php echo ((is_array($_tmp='hildebrand06')) ? $this->_run_mod_handler('ref', true, $_tmp) : $this->_plugins['modifier']['ref'][0][0]->ref($_tmp)); ?>
]. In the matrices the propensity of all amino acids to contact another helix, the membrane or water, is stored for every position (i. e. at the contact, at position +2 or -4 relative to the contact). The propensity matrices are shown below and available for <a href="data/propensity_matrices.zip">download</a> (including corresponding standard deviation matrices based on all subsets excluding one protein).
      <br/>
      The matrices are regularly updated using the growing information on high resolution membrane protein structures (see <a href="http://blanco.biomol.uci.edu/Membrane_Proteins_xtal.html">here</a> for an overview). The last analysis and evaluation published in 2006 was based on a data set that was only about half the size of the present data set. It resulted in an AUC (area under curve = sensitivity/specificity) prediction value of up to <b>76%</b> [<?php echo ((is_array($_tmp='hildebrand06')) ? $this->_run_mod_handler('ref', true, $_tmp) : $this->_plugins['modifier']['ref'][0][0]->ref($_tmp)); ?>
]. With the updated data set the accuracy of the prediction enhanced by <b>3-5%</b>. With growing data a continuous improvement of the predictions is expected.    
    </p>
  ...
  <div class="textblock">
    ...
    <p>
      ...
      width are assessed as well [<?php echo ((is_array($_tmp='hildebrand06')) ? $this->_run_mod_handler('ref', true, $_tmp) : $this->_plugins['modifier']['ref'][0][0]->ref($_tmp)); ?>
].
  ...
  <div class="textblock">
    ...
    <p>
      In the helix-helix matrix of channels a clear periodicity of 4.0 is observed, while in membrane-coils the periodicity is 3.5 [<?php echo ((is_array($_tmp='hildebrand06')) ? $this->_run_mod_handler('ref', true, $_tmp) : $this->_plugins['modifier']['ref'][0][0]->ref($_tmp)); ?>
].
      <span class="moreLess"></span>
    </p>
    <p>
The best predictions for channels are obtained with the channels scale using a window width of 4 amino acids. For membrane-coils, best predictions are obtained with the membrane-coils scale and a window width of 7 amino acids. The different periodicity correlates with the different packing modes of the transmembrane helices that is <i>right-handed</i> crossing angles in channels and <i>left-handed</i> crossing angles in membrane-coils [<?php echo ((is_array($_tmp='hildebrand08')) ? $this->_run_mod_handler('ref', true, $_tmp) : $this->_plugins['modifier']['ref'][0][0]->ref($_tmp)); ?>
].
    </p>
...
<div align="center">
  <?php $_from = $this->_tpl_vars['propMatrices']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['a']):
?>
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "methods_learning_matrix.tpl", 'smarty_include_vars' => array()));
