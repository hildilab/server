<?php /* Smarty version 2.6.20, created on 2018-05-07 09:00:16
         compiled from methods_general.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ref', 'methods_general.tpl', 25, false),)), $this); ?>
<h2>Workflow</h2>
...
<div class="contentblock">
  ...
  <div class="textblock">
    <p>
      RHYTHM combines a structure based prediction method (matrix prediction) with evolutionary information (Pfam-domains) to gain information on the exposure or burial of every transmembrane residue. Moreover, RHYTHM takes into account the structural specificities of membrane proteins with different functions, i.  e. treating channels and transporters (subsumed as <i>channels</i>) different from other membrane proteins (<i>membrane-coils</i>) [<?php echo ((is_array($_tmp='hildebrand06')) ? $this->_run_mod_handler('ref', true, $_tmp) : $this->_plugins['modifier']['ref'][0][0]->ref($_tmp)); ?>
]. RHYTHM also integrates the secondary structure prediction <a href="http://www.enzim.hu/hmmtop/">HMMTOP</a> [<?php echo ((is_array($_tmp='hmmtop')) ? $this->_run_mod_handler('ref', true, $_tmp) : $this->_plugins['modifier']['ref'][0][0]->ref($_tmp)); ?>
].
    </p>
  </div>
