	...
	smaller than 1 &Aring are removed from the results list.</p>
	 ...
	 which is displayed in the NGL viewer.</p>
       ...
       <h2>Tool comparison</h2>
        <p>To compare performance of SL2 with other modeling tools, the RMSD values
	   of RAPPER, PLOP, MODELLER and FREAD were generated applying the reference dataset used in Choi and Deane, Proteins 2009 and
           the RMSD values of SL2 (method & LIP database updated in 2016) were generated applying the reference dataset used in Michalsky, Goesde, Preissner, Protein Eng. 2003.
           SL2 performs significantly better (independent of length) than modeller and Plopn and comparable to
           Rapper and Fread.
         </p>
        <div align=center>
        <img src="pictures/tool-comparison.png" width="80%" height="80%" alt="logo">
         </div>
